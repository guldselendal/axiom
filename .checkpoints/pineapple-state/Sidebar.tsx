...
const Sidebar = forwardRef<SidebarHandle, SidebarProps>(({ onOpenFile, onFileRename, onFileDelete, currentCanvas, onCanvasChange, canvases, onCanvasListUpdate, isHidden = false, onToggleHide: _onToggleHide, canvasNotes = [] }, ref) => {
