...
export interface Note {
  id: string;
  worldX: number;  // World X coordinate (never depends on pan/zoom)
  worldY: number;  // World Y coordinate (never depends on pan/zoom)
  width: number;
  height: number;
  content: string;  // Note content (markdown)
  title?: string;   // Note title (first line of content)
  color?: string;
  filePath?: string; // Path to the markdown file
  canvasId?: string; // If set, this note represents a canvas card
}
