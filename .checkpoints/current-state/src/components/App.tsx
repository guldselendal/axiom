...
import { saveZoom, loadZoom, loadCurrentCanvas, saveCurrentCanvas, loadCanvasList, saveCanvasList, forceSave, loadNotes, saveNotes } from './utils/storage'
  ...
  return (
    ...
    <div className="flex flex-1 overflow-hidden relative">
      ...
      <Sidebar
        ...
        canvasNotes={notes}
        onCreateNoteOnCanvas={(filePath, noteType) => {
          // Use the global function exposed by MegaSurface
      ...
      <div className="flex flex-col flex-1 relative">
        <MegaSurface 
          ...
          onCreateNoteOnCanvas={(filePath, noteType) => {
            // This will expose window.__createNoteOnCanvas
          }}
          onFileCreated={async (_filePath) => {
            // Refresh sidebar file list when a new file is created
            setTimeout(async () => {
