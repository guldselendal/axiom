              ...
              <div style={{
                ...
                {note.excalidrawData && note.excalidrawData.elements && note.excalidrawData.elements.length > 0 ? (
                  <div style={{
                    ...
                    <ExcalidrawPreview
                      key={`preview-${note.id}-${note.updatedAt || 0}-${note.excalidrawData?.elements?.length || 0}-${note.excalidrawData?.elements?.reduce((acc, e) => acc + (e.updated || 0), 0) || 0}`}
          ...
          return (
            <ExcalidrawNoteEditor
              ...
              onSave={async (excalidrawData, newFilePath) => {
                ...
                if (filePath) {
                  console.log('MegaSurface: onSave - Updating note, elements count:', excalidrawData.elements?.length);
