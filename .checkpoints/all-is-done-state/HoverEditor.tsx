...
const HoverEditor = forwardRef<HoverEditorHandle, HoverEditorProps>((props, ref) => {
  const { note, position, filePath, onSave, onClose, onLinkClick, onDelete, onFileCreated, allNotes = [], onPositionChange, canvases = [] } = props
  ...
  return (
    ...
    >
      ...
      {/* Editor Content */}
      <div className="px-6 py-6 overflow-y-auto flex flex-col" style={{ backgroundColor: '#ffffff', height: `${finalEditorHeight - 112}px`, overflowY: 'auto' }}>
