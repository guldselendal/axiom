          ...
          >
            {note.canvasId ? (
              ...
              <div style={{
                ...
                <svg style={{ width: '32px', height: '32px', color: '#8b5cf6', marginBottom: '8px' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              onSave={async (excalidrawData, newFilePath) => {
                ...
                if (newFilePath) {
                  ...
                  if (onFileRename && editingNote.filePath) {
                    ...
                    const title = fileName.endsWith('.excalidraw') ? fileName.slice(0, -11) : fileName;
                    onFileRename(editingNote.filePath, newFilePath, title);
                  }
                }
                
                // Save to file
                if (editingNote.filePath || newFilePath) {
